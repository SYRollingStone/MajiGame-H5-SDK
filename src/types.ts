...
export interface ResolvedSecurityOptions {
  antiDebug: ResolvedAntiDebugOptions & { enabled: boolean }
  shortcuts: ResolvedShortcutsOptions & { enabled: boolean }
  domainLock: ResolvedDomainLockOptions & { enabled: boolean }
}
